...
#allow loopback
sed -i '/listen_address/i listen_address = '*' ' /var/lib/pgsql/data/pg_hba.conf
...
sudo -u postgres /usr/bin/psql -d ocenpbx -c "DROP SCHEMA public cascade;";
sudo -u postgres /usr/bin/psql -d ocenpbx -c "CREATE SCHEMA public;";
...
sudo -u freeswitch /usr/bin/psql -d freeswitch -c "CREATE TABLE IF NOT EXISTS userinfo(username varchar(16) NOT NULL, password varchar(16) NOT NULL, dtmf varchar(16), qualify varchar(16), grade varchar(16));"
sudo -u freeswitch /usr/bin/psql -d freeswitch -c "CREATE TABLE conference(confnum varchar(16) NOT NULL, confname varchar(16) NOT NULL, confuserpin varchar(16), confadminpin varchar(16), mode varchar(16));"
